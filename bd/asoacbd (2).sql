...
-- Tiempo de generación: 03-11-2018 a las 02:25:27
...
CREATE TABLE `productos` (
  ...
  `NumBodega` int(11) DEFAULT NULL,
  `marca` varchar(45) DEFAULT NULL,
  `unidadMedida` varchar(45) DEFAULT NULL,
  `porcionar` int(11) DEFAULT NULL,
  `porcionesProducto` int(11) DEFAULT NULL,
  `descuento` int(11) DEFAULT NULL,
  `idPorcionProducto` int(11) DEFAULT NULL,
...
INSERT INTO `productos` (`idProducto`, `pro_nombre`, `pro_stock`, `pro_stock_minimo`, `pro_preciocompra`, `pro_precioventa`, `NumBodega`, `marca`, `unidadMedida`, `porcionar`, `porcionesProducto`, `descuento`, `idPorcionProducto`, `img`, `Categoria_idCategoria`) VALUES
(3565, 'uno', 0, 88, 78, 98, 1, 'jljk', 'NULL', 0, 0, 0, 0, 'public/uploads/1541229509.png', 2);

--
-- Disparadores `productos`
--
DELIMITER $$
CREATE TRIGGER `Asignar` BEFORE INSERT ON `productos` FOR EACH ROW begin
	set @codigo=new.idProducto;
	set new.idPorcionProducto=@codigo;
end
$$
DELIMITER ;
...
--
ALTER TABLE `productos`
  MODIFY `idProducto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3566;
--
